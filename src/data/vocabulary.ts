...
export const vocabulary: Word[] = [
  ...
  { id: 422, word: 'brush', translation: 'fırçalamak', example: 'She brushes her teeth every morning.', level: 'easy', cefrLevel: 'A1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 423, word: 'climb', translation: 'tırmanmak', example: 'The children love to climb trees in the park.', level: 'easy', cefrLevel: 'A2', partOfSpeech: 'verb', topic: 'nature' },
  { id: 424, word: 'choose', translation: 'seçmek', example: 'You can choose any book from the shelf.', level: 'easy', cefrLevel: 'A2', partOfSpeech: 'verb', topic: 'daily' },
  { id: 425, word: 'carry', translation: 'taşımak', example: 'Can you carry this bag for me?', level: 'easy', cefrLevel: 'A1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 426, word: 'wake', translation: 'uyanmak', example: 'I wake up early every day.', level: 'easy', cefrLevel: 'A1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 427, word: 'smile', translation: 'gülümsemek', example: 'She smiled when she saw her friend.', level: 'easy', cefrLevel: 'A1', partOfSpeech: 'verb', topic: 'social' },
  { id: 428, word: 'rest', translation: 'dinlenmek', example: 'You should rest after a long day at work.', level: 'easy', cefrLevel: 'A1', partOfSpeech: 'verb', topic: 'health' },
  { id: 429, word: 'wash', translation: 'yıkamak', example: 'Please wash your hands before eating.', level: 'easy', cefrLevel: 'A1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 430, word: 'visit', translation: 'ziyaret etmek', example: 'We plan to visit my grandmother this weekend.', level: 'easy', cefrLevel: 'A2', partOfSpeech: 'verb', topic: 'social' },
  { id: 431, word: 'spend', translation: 'harcamak', example: 'She spends a lot of time reading.', level: 'easy', cefrLevel: 'A2', partOfSpeech: 'verb', topic: 'daily' },
  { id: 432, word: 'share', translation: 'paylaşmak', example: 'They shared the pizza with their classmates.', level: 'easy', cefrLevel: 'A2', partOfSpeech: 'verb', topic: 'social' },
  { id: 433, word: 'celebrate', translation: 'kutlamak', example: 'We celebrate my birthday every year.', level: 'easy', cefrLevel: 'A2', partOfSpeech: 'verb', topic: 'social' },
  ...
  { id: 392, word: 'visa', translation: 'vize', example: 'She applied for a tourist visa to visit France.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 393, word: 'border', translation: 'sınır', example: 'We crossed the border early in the morning.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 394, word: 'currency', translation: 'para birimi', example: 'What currency do they use in Japan?', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 395, word: 'souvenir', translation: 'hâtıra eşyası', example: 'She bought a small souvenir at the market.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 396, word: 'delay', translation: 'gecikme', example: 'The flight delay caused us to miss our connection.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 397, word: 'transit', translation: 'aktarma', example: 'We had a three-hour transit in Dubai.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 398, word: 'landmark', translation: 'simge yapı', example: 'The Eiffel Tower is a famous landmark in Paris.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'travel' },
  { id: 399, word: 'excursion', translation: 'gezi', example: 'We went on a day excursion to the nearby islands.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'travel' },
  { id: 400, word: 'fare', translation: 'bilet ücreti', example: 'The train fare is cheaper if you book in advance.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 401, word: 'explore', translation: 'keşfe çıkmak', example: 'We decided to explore the old city on foot.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'travel' },
  { id: 402, word: 'ferry', translation: 'feribot', example: 'We took the ferry across the bay.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 403, word: 'embassy', translation: 'büyükelçilik', example: 'She registered her trip at the embassy.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'travel' },
  { id: 404, word: 'pollution', translation: 'kirlilik', example: 'Air pollution is a major problem in big cities.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 405, word: 'species', translation: 'tür', example: 'Many species of birds migrate in the autumn.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'nature' },
  { id: 406, word: 'conservation', translation: 'koruma', example: 'Wildlife conservation is essential for future generations.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'nature' },
  { id: 407, word: 'flood', translation: 'sel', example: 'The flood damaged many homes near the river.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 408, word: 'shore', translation: 'kıyı', example: 'We walked along the shore as the sun set.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 409, word: 'renewable', translation: 'yenilenebilir', example: 'Solar energy is a renewable source of power.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'adjective', topic: 'nature' },
  { id: 410, word: 'meadow', translation: 'çayır', example: 'The children played in the green meadow.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 411, word: 'canyon', translation: 'kanyon', example: 'The canyon was carved by a river over thousands of years.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 412, word: 'software', translation: 'yazılım', example: 'The company developed new software for data analysis.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 413, word: 'update', translation: 'güncelleme', example: 'Please install the latest update before using the app.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 414, word: 'platform', translation: 'platform', example: 'This platform connects buyers and sellers online.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 415, word: 'virtual', translation: 'sanal', example: 'The students attended a virtual classroom session.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'adjective', topic: 'technology' },
  { id: 416, word: 'database', translation: 'veritabanı', example: 'The hospital keeps all patient records in a secure database.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'technology' },
  { id: 417, word: 'wireless', translation: 'kablosuz', example: 'The printer connects via a wireless signal.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'adjective', topic: 'technology' },
  { id: 418, word: 'interface', translation: 'arayüz', example: 'The user interface is clean and easy to navigate.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'technology' },
  { id: 419, word: 'automated', translation: 'otomatik', example: 'Many tasks in the factory are now automated.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'adjective', topic: 'technology' },
  { id: 420, word: 'backup', translation: 'yedekleme', example: 'Always keep a backup of your important files.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 421, word: 'server', translation: 'sunucu', example: 'The server stores all the data for the website.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 434, word: 'nutrition', translation: 'beslenme', example: 'Good nutrition is important for a healthy lifestyle.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'health' },
  { id: 435, word: 'therapy', translation: 'terapi', example: 'She attends weekly therapy sessions for anxiety.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'health' },
  { id: 436, word: 'prevention', translation: 'önleme', example: 'Prevention is better than cure.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'health' },
  { id: 437, word: 'vaccine', translation: 'aşı', example: 'The doctor recommended a vaccine before the trip.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'health' },
  { id: 438, word: 'fatigue', translation: 'yorgunluk', example: 'Chronic fatigue can affect your daily performance.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'health' },
  { id: 439, word: 'allergy', translation: 'alerji', example: 'She has a severe allergy to peanuts.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'health' },
  { id: 440, word: 'treatment', translation: 'tedavi', example: 'The doctor suggested a new treatment for the condition.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'health' },
  { id: 441, word: 'infection', translation: 'enfeksiyon', example: 'The cut became infected and needed treatment.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'health' },
  { id: 442, word: 'hygiene', translation: 'hijyen', example: 'Good hygiene helps prevent the spread of illness.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'health' },
  { id: 443, word: 'diagnose', translation: 'teşhis koymak', example: 'The doctor was able to diagnose the illness quickly.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'health' },
  { id: 444, word: 'prescribe', translation: 'reçete yazmak', example: 'The doctor prescribed medication for the infection.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'health' },
  { id: 445, word: 'rehabilitate', translation: 'rehabilite etmek', example: 'The patient worked hard to rehabilitate after surgery.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'health' },
  { id: 446, word: 'dosage', translation: 'dozaj', example: 'Follow the correct dosage instructions on the label.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'health' },
  { id: 447, word: 'consult', translation: 'danışmak', example: 'You should consult a doctor before taking this medication.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'health' },
  { id: 454, word: 'arrange', translation: 'düzenlemek', example: 'She arranged all the documents on the desk.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 455, word: 'handle', translation: 'üstesinden gelmek', example: 'He handled the situation calmly and professionally.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 456, word: 'adjust', translation: 'ayarlamak', example: 'You can adjust the settings in the menu.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 457, word: 'accomplish', translation: 'başarmak', example: 'She accomplished all her goals by the end of the year.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'daily' },
  { id: 458, word: 'routine', translation: 'rutin', example: 'Exercise is part of his daily routine.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'daily' },
  { id: 459, word: 'priority', translation: 'öncelik', example: 'Health should be your top priority.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'daily' },
  { id: 476, word: 'frustrate', translation: 'hayal kırıklığına uğratmak', example: 'It frustrated her when nobody listened to her ideas.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 477, word: 'reassure', translation: 'güvence vermek', example: 'He reassured his friend that everything would be fine.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 478, word: 'admire', translation: 'hayran olmak', example: 'She admired his patience and dedication to the work.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 479, word: 'regret', translation: 'pişmanlık duymak', example: 'He regretted not calling his friend sooner.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 480, word: 'envy', translation: 'kıskanmak', example: 'She envied her colleague\'s ability to stay calm under pressure.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 481, word: 'sympathize', translation: 'sempati duymak', example: 'I sympathize with what you are going through.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 482, word: 'overwhelm', translation: 'bunaltmak', example: 'The amount of work overwhelmed her completely.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 483, word: 'ashamed', translation: 'utanmış', example: 'He felt ashamed after raising his voice at his colleague.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 484, word: 'optimistic', translation: 'iyimser', example: 'Despite the setbacks, she remained optimistic about the future.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 485, word: 'nostalgic', translation: 'nostaljik', example: 'The old photograph made her feel deeply nostalgic.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 486, word: 'stream', translation: 'akış', example: 'You can stream the film directly from the app.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'verb', topic: 'technology' },
  { id: 487, word: 'debug', translation: 'hata ayıklamak', example: 'The developer spent hours trying to debug the code.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'technology' },
  { id: 488, word: 'deploy', translation: 'dağıtmak', example: 'The team deployed the new version of the software overnight.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'technology' },
  { id: 489, word: 'migrate', translation: 'taşımak', example: 'We decided to migrate all data to the new server.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'verb', topic: 'technology' },
  { id: 500, word: 'semester', translation: 'dönem', example: 'She completed four courses in her first semester.', level: 'medium', cefrLevel: 'B1', partOfSpeech: 'noun', topic: 'education' },
  { id: 501, word: 'syllabus', translation: 'ders izlencesi', example: 'The professor handed out the syllabus on the first day.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'education' },
  { id: 502, word: 'plagiarism', translation: 'intihal', example: 'Submitting someone else\'s work as your own is plagiarism.', level: 'medium', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'education' },
  ...
  { id: 203, word: 'ambiguous', translation: 'belirsiz', example: 'The instructions are ambiguous.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 204, word: 'meticulous', translation: 'titiz', example: 'She is meticulous in her work.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'daily' },
  ...
  { id: 206, word: 'eloquent', translation: 'belagatlı', example: 'The president gave an eloquent speech.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 207, word: 'ambivalent', translation: 'kararsız', example: 'I feel ambivalent about the decision.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 208, word: 'pragmatic', translation: 'pragmatik', example: 'We need a pragmatic solution.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 209, word: 'cynical', translation: 'alaycı', example: 'He has a cynical view of politics.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 210, word: 'alleviate', translation: 'hafifletmek', example: 'This medicine will alleviate the pain.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'health' },
  { id: 211, word: 'exacerbate', translation: 'kötüleştirmek', example: 'Stress can exacerbate health problems.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'health' },
  { id: 212, word: 'phenomenon', translation: 'olgu', example: 'This is a natural phenomenon.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 213, word: 'paradox', translation: 'paradoks', example: 'It is a strange paradox.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 214, word: 'fundamental', translation: 'temel', example: 'This is a fundamental right.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 215, word: 'contemporary', translation: 'çağdaş', example: 'He is a contemporary artist.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 216, word: 'elaborate', translation: 'ayrıntılı', example: 'She gave an elaborate explanation.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 217, word: 'scrutinize', translation: 'incelemek', example: 'We must scrutinize the data carefully.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'academic' },
  { id: 218, word: 'indigenous', translation: 'yerli', example: 'The indigenous people have rich traditions.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 219, word: 'perpetual', translation: 'sürekli', example: 'They are in perpetual conflict.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 220, word: 'resilient', translation: 'dayanıklı', example: 'Children are very resilient.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 221, word: 'profound', translation: 'derin', example: 'The experience had a profound impact.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 222, word: 'ambition', translation: 'hırs', example: 'Her ambition drives her success.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'emotions' },
  { id: 223, word: 'coherent', translation: 'tutarlı', example: 'Please give a coherent explanation.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 224, word: 'dilemma', translation: 'ikilem', example: 'I face a difficult dilemma.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'daily' },
  { id: 225, word: 'concise', translation: 'özlü', example: 'Keep your report concise.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 226, word: 'ambiguity', translation: 'belirsizlik', example: 'The ambiguity of the law causes problems.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 227, word: 'implication', translation: 'sonuç', example: 'What are the implications of this decision?', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 228, word: 'hypothesis', translation: 'hipotez', example: 'The scientist tested the hypothesis.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 229, word: 'empirical', translation: 'ampirik', example: 'We need empirical evidence.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  ...
  { id: 231, word: 'rationale', translation: 'gerekçe', example: 'What is the rationale behind this decision?', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 232, word: 'substantial', translation: 'önemli miktarda', example: 'There has been a substantial improvement.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 233, word: 'diminish', translation: 'azalmak', example: 'Do not let fear diminish your courage.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'emotions' },
  { id: 234, word: 'sustain', translation: 'sürdürmek', example: 'We must sustain our efforts.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 235, word: 'acknowledge', translation: 'kabul etmek', example: 'Please acknowledge receipt of this message.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 236, word: 'attribute', translation: 'atfetmek', example: 'His success is attributed to hard work.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'academic' },
  { id: 237, word: 'contradict', translation: 'çelişmek', example: 'These facts contradict each other.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'academic' },
  { id: 238, word: 'illustrate', translation: 'örneklemek', example: 'Let me illustrate this with an example.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'education' },
  { id: 239, word: 'implement', translation: 'uygulamak', example: 'We will implement the new policy.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'business' },
  ...
  { id: 241, word: 'manipulate', translation: 'manipüle etmek', example: 'Do not let others manipulate you.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'social' },
  { id: 242, word: 'constitute', translation: 'oluşturmak', example: 'This constitutes a serious problem.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'academic' },
  { id: 243, word: 'controversial', translation: 'tartışmalı', example: 'The decision was very controversial.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 244, word: 'obsolete', translation: 'modası geçmiş', example: 'This technology is now obsolete.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'technology' },
  { id: 245, word: 'lucid', translation: 'anlaşılır', example: 'Her explanation was very lucid.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 246, word: 'daunting', translation: 'yıldırıcı', example: 'The task ahead is daunting.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 247, word: 'intricate', translation: 'karmaşık', example: 'The design is very intricate.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'daily' },
  { id: 248, word: 'eloquence', translation: 'belagat', example: 'She spoke with great eloquence.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'social' },
  { id: 249, word: 'leverage', translation: 'kaldıraç etkisi', example: 'Use your skills as leverage.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'business' },
  { id: 250, word: 'mitigate', translation: 'hafifletmek', example: 'We must mitigate the risk.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'business' },
  { id: 251, word: 'plausible', translation: 'makul', example: 'That sounds plausible to me.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 252, word: 'prevail', translation: 'galip gelmek', example: 'Good always prevails over evil.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  ...
  { id: 254, word: 'rigorous', translation: 'titiz', example: 'The research was very rigorous.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 255, word: 'spontaneous', translation: 'kendiliğinden', example: 'Her laughter was spontaneous.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 256, word: 'tenacious', translation: 'azimli', example: 'A tenacious person never gives up.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 257, word: 'ubiquitous', translation: 'her yerde bulunan', example: 'Smartphones are now ubiquitous.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'technology' },
  { id: 258, word: 'verbose', translation: 'gereksiz ayrıntılı', example: 'His writing style is too verbose.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 259, word: 'volatile', translation: 'değişken', example: 'The market is very volatile.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'business' },
  { id: 260, word: 'zealous', translation: 'gayretli', example: 'She is a zealous supporter of the cause.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 261, word: 'benevolent', translation: 'hayırsever', example: 'He is a benevolent leader.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 262, word: 'candid', translation: 'açık sözlü', example: 'Be candid with your feedback.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 263, word: 'clemency', translation: 'merhamet', example: 'The judge showed clemency.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'noun', topic: 'social' },
  { id: 264, word: 'deference', translation: 'saygı', example: 'Show deference to your elders.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'noun', topic: 'social' },
  { id: 265, word: 'eminent', translation: 'seçkin', example: 'She is an eminent scientist.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 266, word: 'fathom', translation: 'kavramak', example: 'I cannot fathom his reasoning.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 267, word: 'gregarious', translation: 'sosyal', example: 'She is a gregarious person.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'social' },
  { id: 268, word: 'hasten', translation: 'acele etmek', example: 'We must hasten the process.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 269, word: 'impeccable', translation: 'kusursuz', example: 'Her taste in fashion is impeccable.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'daily' },
  { id: 270, word: 'judicious', translation: 'basiretli', example: 'Make judicious use of your resources.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 271, word: 'laudable', translation: 'övgüye değer', example: 'Your effort is truly laudable.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 272, word: 'lucrative', translation: 'kârlı', example: 'It is a very lucrative business.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'business' },
  { id: 273, word: 'magnanimous', translation: 'cömert ruhlu', example: 'He was magnanimous in victory.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'social' },
  { id: 274, word: 'nonchalant', translation: 'umursamaz', example: 'She seemed nonchalant about the result.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 275, word: 'ostentatious', translation: 'gösteriş meraklısı', example: 'His lifestyle is very ostentatious.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'social' },
  { id: 276, word: 'pervasive', translation: 'her yere yayılan', example: 'Fear was pervasive in the community.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'social' },
  { id: 277, word: 'quintessential', translation: 'en tipik', example: 'This is the quintessential example.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 278, word: 'rhetoric', translation: 'retorik', example: 'His speech was full of rhetoric.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 279, word: 'sagacious', translation: 'bilge', example: 'A sagacious leader makes wise choices.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 280, word: 'taciturn', translation: 'suskun', example: 'He is a very taciturn man.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'social' },
  { id: 281, word: 'unequivocal', translation: 'kesin', example: 'Give an unequivocal answer.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 282, word: 'venerate', translation: 'saygı göstermek', example: 'They venerate their ancestors.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'verb', topic: 'social' },
  { id: 283, word: 'wary', translation: 'ihtiyatlı', example: 'Be wary of strangers.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'daily' },
  ...
  { id: 285, word: 'yearning', translation: 'özlem', example: 'She felt a yearning for home.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'emotions' },
  { id: 286, word: 'zeal', translation: 'gayret', example: 'He works with great zeal.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'emotions' },
  { id: 287, word: 'auspicious', translation: 'uğurlu', example: 'This is an auspicious beginning.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'daily' },
  { id: 288, word: 'brevity', translation: 'kısalık', example: 'Brevity is the soul of wit.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 289, word: 'corroborate', translation: 'doğrulamak', example: 'Can you corroborate this claim?', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'academic' },
  { id: 290, word: 'decorum', translation: 'terbiye', example: 'Please maintain decorum in meetings.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'noun', topic: 'social' },
  { id: 291, word: 'effervescent', translation: 'neşeli', example: 'She has an effervescent personality.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 292, word: 'fortuitous', translation: 'tesadüfi', example: 'Their meeting was fortuitous.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'daily' },
  { id: 293, word: 'grandiose', translation: 'abartılı', example: 'He had grandiose plans.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'emotions' },
  { id: 294, word: 'hubris', translation: 'kibir', example: 'His hubris led to his downfall.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'noun', topic: 'social' },
  { id: 295, word: 'immutable', translation: 'değişmez', example: 'Some laws of physics are immutable.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 296, word: 'juxtapose', translation: 'yan yana koymak', example: 'The artist juxtaposes light and shadow.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'verb', topic: 'academic' },
  { id: 297, word: 'laconic', translation: 'kısa ve öz', example: 'His response was laconic but meaningful.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'academic' },
  { id: 298, word: 'mendacious', translation: 'yalancı', example: 'Beware of mendacious claims.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'adjective', topic: 'social' },
  { id: 299, word: 'nuance', translation: 'nüans', example: 'There are many nuances in language.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  { id: 300, word: 'obfuscate', translation: 'karmaşıklaştırmak', example: 'Do not obfuscate the truth.', level: 'hard', cefrLevel: 'C2', partOfSpeech: 'verb', topic: 'academic' },
  ...
  { id: 337, word: 'navigate', translation: 'yol bulmak', example: 'It is difficult to navigate in an unfamiliar city.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'travel' },
  { id: 338, word: 'embark', translation: 'yola çıkmak', example: 'We are about to embark on a new adventure.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'travel' },
  ...
  { id: 340, word: 'revenue', translation: 'gelir', example: 'The company\'s annual revenue has doubled.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'business' },
  ...
  { id: 344, word: 'discrepancy', translation: 'uyuşmazlık', example: 'There is a discrepancy in the financial data.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'academic' },
  ...
  { id: 448, word: 'pedagogy', translation: 'pedagoji', example: 'She studied pedagogy to understand how children learn.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'education' },
  { id: 449, word: 'curriculum', translation: 'müfredat', example: 'The school revised its curriculum to include digital skills.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'education' },
  { id: 450, word: 'dissertation', translation: 'tez', example: 'He spent two years writing his doctoral dissertation.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'education' },
  { id: 451, word: 'cognition', translation: 'biliş', example: 'Language acquisition is closely linked to cognition.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'education' },
  { id: 452, word: 'scholarship', translation: 'burs', example: 'She received a scholarship to study abroad.', level: 'hard', cefrLevel: 'B2', partOfSpeech: 'noun', topic: 'education' },
  { id: 453, word: 'tenure', translation: 'kadro', example: 'The professor was granted tenure after years of research.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'education' },
  { id: 461, word: 'procrastinate', translation: 'ertelemek', example: 'He tends to procrastinate when the task feels overwhelming.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 462, word: 'delegate', translation: 'yetki vermek', example: 'A good manager knows how to delegate tasks effectively.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 463, word: 'contemplate', translation: 'düşünmek', example: 'She sat quietly, contemplating her next move.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 464, word: 'persevere', translation: 'azimle devam etmek', example: 'Despite the difficulties, he persevered and succeeded.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'daily' },
  { id: 465, word: 'meander', translation: 'dolanmak', example: 'The river meanders slowly through the valley.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'nature' },
  { id: 466, word: 'quarantine', translation: 'karantina', example: 'Travellers were placed in quarantine upon arrival.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 467, word: 'deportation', translation: 'sınır dışı etme', example: 'He faced deportation after overstaying his visa.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 468, word: 'consulate', translation: 'konsolosluk', example: 'She went to the consulate to get her visa renewed.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 469, word: 'repatriate', translation: 'yurduna döndürmek', example: 'The government agreed to repatriate the stranded citizens.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'travel' },
  { id: 470, word: 'rendezvous', translation: 'buluşma noktası', example: 'They agreed on a rendezvous point near the main square.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 471, word: 'traverse', translation: 'geçmek', example: 'The hikers traversed the mountain range in three days.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'travel' },
  { id: 472, word: 'disembark', translation: 'karaya çıkmak', example: 'Passengers were asked to disembark in an orderly manner.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'travel' },
  { id: 473, word: 'smuggle', translation: 'kaçakçılık yapmak', example: 'Customs officers found items smuggled in the luggage.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'verb', topic: 'travel' },
  { id: 474, word: 'detour', translation: 'alternatif güzergah', example: 'We took a detour to avoid the traffic on the main road.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 475, word: 'trek', translation: 'uzun yürüyüş', example: 'They went on a week-long trek through the jungle.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'travel' },
  { id: 490, word: 'latency', translation: 'gecikme süresi', example: 'High latency causes noticeable lag in online games.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 491, word: 'scalability', translation: 'ölçeklenebilirlik', example: 'Scalability is a key factor when designing large systems.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 492, word: 'infrastructure', translation: 'altyapı', example: 'The country invested heavily in digital infrastructure.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 493, word: 'cybersecurity', translation: 'siber güvenlik', example: 'Companies must invest in cybersecurity to protect user data.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 494, word: 'authentication', translation: 'kimlik doğrulama', example: 'Two-factor authentication adds an extra layer of security.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'technology' },
  { id: 495, word: 'glacier', translation: 'buzul', example: 'The glacier has retreated significantly over the past century.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 496, word: 'biodiversity', translation: 'biyoçeşitlilik', example: 'The rainforest supports extraordinary biodiversity.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 497, word: 'deforestation', translation: 'ormansızlaşma', example: 'Deforestation threatens the habitat of many species.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 498, word: 'monsoon', translation: 'muson', example: 'The monsoon season brings heavy rain to the region each year.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'nature' },
  { id: 499, word: 'sediment', translation: 'tortu', example: 'The river deposits sediment as it slows near the delta.', level: 'hard', cefrLevel: 'C1', partOfSpeech: 'noun', topic: 'nature' },
];
// ─── VOCABULARY DATA END ──────────────────────────────────────────────────────
